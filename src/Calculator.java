...
public class Calculator {
    ...
    public Calculator(DataInputOutput inputOutput, DataVerification verification, ConverterNumber converterNumber, Calc calc) {
    ...
    void start() throws IncorrectDataEntryException {
        ...
        while (!(str = inputOutput.input()).equals("Exit")) {
            ...
            } else throw new IncorrectDataEntryException("Неверные введены данные!");
        }
    }
}
